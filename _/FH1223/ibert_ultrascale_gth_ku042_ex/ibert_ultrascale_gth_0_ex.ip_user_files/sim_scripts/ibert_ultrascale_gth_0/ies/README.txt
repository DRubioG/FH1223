...
#
# Generated by export_simulation on Thu Nov 03 10:39:19 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './ibert_ultrascale_gth_0.sh' script.

./ibert_ultrascale_gth_0.sh -reset_run
...
./ibert_ultrascale_gth_0.sh -noclean_files

For more information on the script, please type './ibert_ultrascale_gth_0.sh -help'.
